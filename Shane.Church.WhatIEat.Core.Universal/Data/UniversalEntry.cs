...
namespace Shane.Church.WhatIEat.Core.Universal.Data
{
    [Table]
    public class UniversalEntry : ChangingObservableObject, IEntry
    {
        public UniversalEntry() { }
...
#pragma warning restore 0169
        ...
        public MealType? MealType
        {
            get 
            {
                if (!_mealType.HasValue)
                {
                    _mealType = Core.Data.MealType.Undefined;
                }
                return _mealType; 
            }
            set
            {
                if (!value.HasValue)
                {
                    value = Core.Data.MealType.Undefined;
                }
