...
(function () {
    try {
        ...
        ia.iaAdTagInternalSettings = {
            ...
            adTagVersion: p.isWP7 ? null : "1.0.2"
        };
        ...
        var f = function () {
            var w = document.getElementById(p.adTagId);
            if (w) {
                try {
        ...
        var c = function () {
            ...
            var A = p.adTagCidLSKeyName + (ia.adSettings && ia.adSettings.APP_ID ? ia.adSettings.APP_ID : "");
            var x = "";
            try {
                if (w) {
                    x = w.getItem(A)
        ...
        var k = function () {
            c();
            if (!ia.adSettings.CID || ia.adSettings.CID === p.defaultCid) {
                r()
            }
            var w = {
            ...
            var x = ia.iaAdTagInternalSettings.adTagURL + "?" + l(w);
            f();
            if (!p.isWP7) {
                (function (B, z) {
                    var y = B.createElement(z),
                      A = B.getElementsByTagName(z)[0];
                    y.id = p.adTagId;
        ...
        var a = function (y) {
            ...
            return w ? MSApp.execUnsafeLocalFunction(function () { return w.appendChild(x); }) : false
        };
        var n = function () {
            if (typeof ia.onXClicked !== "function") {
                ia.onXClicked = function () {
                    p.floatingBannerWasClosed = true;
                    ia.clrRfItvl();
                    o()
                }
            }
        ...
        var t = function () {
            ...
            var x = p.isWP ? p.defaultAdHeightWinPhone : (p.isiPadOrMini ? p.defaultAdHeightiPad : p.defaultAdHeight);
            var w = y && y.clientHeight ? y.clientHeight : x;
            a("#iaXButton {-webkit-tap-highlight-color: transparent; position:absolute; right:0px; bottom:" + w + "px;} body {padding-bottom:" + p.initialBodyPaddingBottom + w + "px}")
        };
        var b = function () {
            t();
        ...
        var u = function () {
            if (ia.adSettings.IS_FLOATING_BANNER && !ia.adSettings.IS_INTERSTITIAL_AD) {
                p.initialBodyPaddingBottom = document.body && typeof window.getComputedStyle === "function" ? parseInt(window.getComputedStyle(document.body).paddingBottom) : 0;
                if (isNaN(p.initialBodyPaddingBottom)) {
                    p.initialBodyPaddingBottom = 0
                }
            }
        }();
        ...
        ia.adWasLoaded = function () {
            ...
            var x = document.getElementById(p.adPlaceHolderDivId);
            var w = document.getElementById(p.adDivId);
            if (w) {
                if (x) {
                    MSApp.execUnsafeLocalFunction(function () {
                        x.appendChild(w)
        ...
        var o = function () {
            ...
            if (ia.adSettings.IS_FLOATING_BANNER && !ia.adSettings.IS_INTERSTITIAL_AD) {
                a("body {padding-bottom:" + p.initialBodyPaddingBottom + "px}")
            }
        };
        var e = (function () {
        ...
        var g = function () {
            ...
            function A() {
                if (w && !z) {
                    ...
                    if (C - y > p.resumeRfrsThresholdInMs) {
            ...
            window.setInterval(A, p.resumeRfrsCheckIntervalInMs)
        };
        var j = function () {
            if (!p.noPlatformShowHideEventSupport) {
                i()
            } else {
                g()
            }
        ...
        var s = function () {
            ia.rfAd = function () {
                if (!p.floatingBannerWasClosed && !ia.adSettings.IS_VIDEO_SUPPORT && !ia.adSettings.IS_INTERSTITIAL_AD) {
